...
import { Search, Filter, LayoutGrid, List, Bell, Moon, Sun } from 'lucide-react';
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-[72px] px-8 flex items-center justify-between border-b border-white/[0.12] z-40 bg-charcoal/80 backdrop-blur-[10px] sticky top-0">
          <div className="flex flex-col">
            ...
            <p className="text-[12px] text-[#8E8E93] font-medium">Chile Central • Tiempo Real</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 flex gap-8">
          ...
          <aside className="w-[320px] flex flex-col gap-6 sticky top-0 h-full border-l border-white/[0.12] pl-8">
            ...
            <button className="w-full py-3 rounded-xl bg-emergency/10 border border-emergency/30 text-emergency font-bold text-[13px] hover:bg-emergency hover:text-pure-white transition-all duration-300 shadow-xl shadow-emergency/5 uppercase tracking-wider">
