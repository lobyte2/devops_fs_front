...
export const HistorialPage = () => {
  ...
  if (loading) {
    return <div className="flex-1 flex items-center justify-center text-white/50">Cargando historial...</div>;
  }

  return (
    <div className="p-8">
      <h2 className="text-2xl font-bold text-pure-white mb-6">Historial de Incidentes (Backend)</h2>
